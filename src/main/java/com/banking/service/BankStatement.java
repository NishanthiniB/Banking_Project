...
private static final String FILE ="C:\\Users\\bnish\\OneDrive\\Documents\\BankStatement.pdf";
...
String customerName = user.getFirstName() + " "+ user.getLastName();
    ...
    float width = 210;
    float height = 297;
    Rectangle statementSize = new Rectangle((int) width, (int) height);
    ...
    PdfPCell bankName = new PdfPCell(new Phrase("SN BANKING"));
    bankName.setBorder(0);
    bankName.setBackgroundColor(BaseColor.LIGHT_GRAY);
    bankName.setPadding(20f);
    PdfPCell bankAddress = new PdfPCell(new Phrase("13, Chennai, India"));
